...
class StateManager(object):
    ...
    def _init_variables(self):
        ...
        self._pickup_location = 'pickup'
        self._delivery_location = ''
        self._delivery_order_id = 0
        self._delivery_message = ''
    ...
    def _init_handles(self):
        # order handle
        self._deliver_order_handler = actionlib.SimpleActionServer(DELIVERY_ACTION, simple_delivery_msgs.P2PDeliveryOrderActionAction, auto_start=False)
    ...
    def _process_deliver_order(self):
        ...
        if self._current_state != STATE_IN_DOCK:
            ...
            r = simple_delivery_msgs.P2PDeliveryOrderActionResult()
            ...
            self._pickup_location = goal.from
            self._delivery_location = goal.to
            self._delivery_message = goal.message # not used yet
    ...
    def _logging(self):
        ...
        feedback = simple_delivery_msgs.P2PDeliveryOrderActionFeedback()
        feedback.delivery_status = simple_delivery_msgs.P2PDeliveryStatus()
        ...
        if self._current_state == STATE_IN_DOCK:
            ...
            feedback.delivery_status.status = simple_delivery_msgs.DeliveryStatus.GO_TO_PICKUP
        elif self._current_state == STATE_AT_PICKUP:
            feedback.delivery_status.status = simple_delivery_msgs.DeliveryStatus.WAITING_FOR_PICKUP_CONFIRM
            ...
            feedback.delivery_status.status = simple_delivery_msgs.DeliveryStatus.WAITING_FOR_RECEIVER_CONFIRM
    ...
    def _state_at_pickup(self):
        ...
        if self._pickup_confirm== True:
            ...
            self.loginfo('Moving To Table : %s'%self._delivery_location)
            self._request_navigator(self._delivery_location, yocs_msgs.NavigateToGoal.APPROACH_ON, 3, 300, 0.0)
    ...
    def _state_at_table(self):
        ...
        if self._customer_confirm == True:
            ...
            # if it has finished delivery. moving back to base
            feedback = simple_delivery_msgs.RobotDeliveryOrderFeedback()
            feedback.delivery_status = simple_delivery_msgs.DeliveryStatus()
